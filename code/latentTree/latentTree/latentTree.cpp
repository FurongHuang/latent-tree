...
int main(int argc, const char * argv[])
{
	...
	*/
	...
	// 4 100000 3 2 0 0.8 0 1 $(SolutionDir)\..\..\dataset\synthetic\samples.txt $(SolutionDir)\..\..\dataset\synthetic\result\sample_matlab.txt $(SolutionDir)\..\..\dataset\synthetic\result\DistanceMatrix.txt $(SolutionDir)\..\..\dataset\synthetic\result\category.txt $(SolutionDir)\..\..\dataset\synthetic\result\nodelist.txt $(SolutionDir)\..\..\dataset\synthetic\result\adjsparse.txt $(SolutionDir)\..\..\dataset\synthetic\result\neighborhood.txt $(SolutionDir)\..\..\dataset\synthetic\result\edgePot.txt
	...
	NVAR = furong_atoi(argv[1]);				// 4;
	NX = furong_atoi(argv[2]);					// 100000 
	VOCA_SIZE = furong_atoi(argv[3]);			// 3
